...
export default function Layout({ children, title = 'Gaganshipping', href }) {
  ...
  +91 - 81434 - 71234, +91 - 98661- 05677</div>
            <div className="text-center flex-grow text-5xl pt-3 text-blue-900 logo-h">
                <h2><img className="h-12 inline-block" src={'../images/logo_new.png'}  style={{'vertical-align': 'bottom'}}/><span>AGAN SHIPPING SERVICES</span></h2>
            </div>
